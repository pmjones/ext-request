...
#line 223 "request_parsers.c"
yy13:
	++in->cur;
#line 113 "request_parsers.re"
	{ token1(&tok, TOKEN_INVALID, in->tok, 1); break; }
#line 228 "request_parsers.c"
yy15:
	++in->cur;
...
yy39:
	++in->cur;
yy40:
#line 131 "request_parsers.re"
	{ token1(&tok, TOKEN_MIME, in->tok, in->cur - in->tok); break; }
#line 513 "request_parsers.c"
yy41:
	++in->cur;
	if (in->lim <= in->cur) { token1(&tok, TOKEN_INVALID, "", 0); return tok; }
	yych = *in->cur;
