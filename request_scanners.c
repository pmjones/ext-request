/* Generated by re2c 0.16 on Sat Aug 27 20:45:22 2016 */
...
#line 339 "request_scanners.c"
}
#line 127 "request_scanners.re"
...
#line 241 "request_scanners.re"
	{ token1(&tok, TOKEN_END, "", 0); return tok; }
#line 540 "request_scanners.c"
yy35:
	++in->cur;
#line 240 "request_scanners.re"
	{ token1(&tok, TOKEN_UNKNOWN, in->tok, 1); return tok; }
#line 545 "request_scanners.c"
yy37:
	++in->cur;
#line 244 "request_scanners.re"
	{ continue; tok.type = TOKEN_WHITESPACE; return tok; }
#line 550 "request_scanners.c"
yy39:
	++in->cur;
yy40:
#line 247 "request_scanners.re"
	{ tok = lex_quoted_str(in, *(in->cur - 1)); return tok; }
#line 556 "request_scanners.c"
yy41:
	yych = *++in->cur;
	switch (yych) {
	case '\'':	goto yy49;
...
yy42:
	++in->cur;
#line 251 "request_scanners.re"
	{ token1(&tok, TOKEN_COMMA, ",", 1); return tok; }
#line 567 "request_scanners.c"
yy44:
	++in->cur;
	yych = *in->cur;
	switch (yych) {
...
yy46:
#line 254 "request_scanners.re"
	{ token1(&tok, TOKEN_ID, in->tok, in->cur - in->tok); return tok; }
#line 641 "request_scanners.c"
yy47:
	++in->cur;
#line 250 "request_scanners.re"
	{ token1(&tok, TOKEN_EQUALS, "=", 1); return tok; }
#line 646 "request_scanners.c"
yy49:
	++in->cur;
#line 248 "request_scanners.re"
	{ token1(&tok, TOKEN_STRING, "", 0); return tok; }
#line 651 "request_scanners.c"
}
#line 255 "request_scanners.re"
