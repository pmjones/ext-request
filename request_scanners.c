/* Generated by re2c 0.16 on Sat Aug 27 20:02:29 2016 */
...
#line 310 "request_scanners.c"
yy23:
	++in->cur;
#line 113 "request_scanners.re"
	{ token1(&tok, TOKEN_SLASH, "/", 1); return tok; }
#line 315 "request_scanners.c"
yy25:
	++in->cur;
#line 114 "request_scanners.re"
	{ token1(&tok, TOKEN_SEMICOLON, ";", 1); return tok; }
#line 320 "request_scanners.c"
yy27:
	++in->cur;
...
yy33:
	++in->cur;
#line 232 "request_scanners.re"
	{ token1(&tok, TOKEN_END, "", 0); return tok; }
#line 531 "request_scanners.c"
yy35:
	++in->cur;
#line 231 "request_scanners.re"
	{ token1(&tok, TOKEN_UNKNOWN, in->tok, 1); return tok; }
#line 536 "request_scanners.c"
yy37:
	++in->cur;
#line 235 "request_scanners.re"
	{ continue; tok.type = TOKEN_WHITESPACE; return tok; }
#line 541 "request_scanners.c"
yy39:
	++in->cur;
yy40:
#line 238 "request_scanners.re"
	{ tok = lex_quoted_str(in, *(in->cur - 1)); return tok; }
#line 547 "request_scanners.c"
yy41:
	yych = *++in->cur;
	switch (yych) {
	case '\'':	goto yy49;
...
yy42:
	++in->cur;
#line 242 "request_scanners.re"
	{ token1(&tok, TOKEN_COMMA, ",", 1); return tok; }
#line 558 "request_scanners.c"
yy44:
	++in->cur;
	yych = *in->cur;
	switch (yych) {
...
yy46:
#line 245 "request_scanners.re"
	{ token1(&tok, TOKEN_ID, in->tok, in->cur - in->tok); return tok; }
#line 632 "request_scanners.c"
yy47:
	++in->cur;
#line 241 "request_scanners.re"
	{ token1(&tok, TOKEN_EQUALS, "=", 1); return tok; }
#line 637 "request_scanners.c"
yy49:
	++in->cur;
#line 239 "request_scanners.re"
	{ token1(&tok, TOKEN_STRING, "", 0); return tok; }
#line 642 "request_scanners.c"
}
#line 246 "request_scanners.re"
